...
def test_merge():
    ...
    mergeUmiFiles("tests/data/r1.fq", "tests/data/r2.fq", "tests/data/merged.fq", "tests/data/extractstat.txt", "tests/data/bcstat.txt", "tests/data/prime5stat.txt", ll1, ll2, llinker)
    ...
    assert open("tests/data/prime5stat.txt",'r').read() == open("tests/data/prime5stat.txt.result",'r').read()
